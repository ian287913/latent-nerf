...
def side_poses(size, device, radius_range=(1.0, 1.5), theta_range=(0.0, 150.0), phi_range=(0.0, 360.0),
...
class ViewsDataset:
    def __init__(self, cfg: RenderConfig, device, type='train', size=100):
        ...
        # ian: create a new type for pure side-view
        self.justside = self.type in ['justside']
